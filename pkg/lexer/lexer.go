...
// readNumber returns the whole digit
...
// readString gets the string characters from opening
// " to closing " or EOF
...
// readIdentifier advances the lexer position as long as
...
// readChar - give the next character and advance position of input str
...
// skipWhitespace will skip over selected character to be ignored
